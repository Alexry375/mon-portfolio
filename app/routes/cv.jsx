...
export const meta = () => {
  return [
    { title: 'Alexis Briend | CV' },
    {
      name: 'description',
      content: 'Curriculum Vitae of Alexis Briend - Engineering Student at ENSEEIHT Toulouse',
    },
  ];
};
...
const cvData = {
  personalInfo: {
    ...
    email: 'alexis.briend375@gmail.com',
    linkedin: 'linkedin.com/in/alexis-briend-b726892b4',
  ...
  skills: {
    programming: ['Python', 'C', 'OCaml', 'Ada', 'Matlab'],
    aiml: ['Machine Learning', 'Deep Learning', 'AI Chatbots', 'Data Analysis'],
    tools: ['Git', 'Discord API', 'Linux', 'Full-stack Development'],
    languages: ['French (Native)', 'English (Intermediate - B1)', 'Japanese (Beginner)'],
  },
  interests: [
    'Machine Learning & AI',
    'Mathematics',
      ...
      <Section className={styles.section}>
        ...
        <div className={styles.skillsGrid}>
          <div className={styles.skillCategory}>
            ...
            <Text size="s">{cvData.skills.programming.join(' • ')}</Text>
          </div>
          <div className={styles.skillCategory}>
            <Heading level={4}>AI & Machine Learning</Heading>
            <Text size="s">{cvData.skills.aiml.join(' • ')}</Text>
          </div>
          <div className={styles.skillCategory}>
            <Heading level={4}>Tools & Platforms</Heading>
            <Text size="s">{cvData.skills.tools.join(' • ')}</Text>
          </div>
          <div className={styles.skillCategory}>
            <Heading level={4}>Languages</Heading>
            <Text size="s">{cvData.skills.languages.join(' • ')}</Text>
          </div>
        </div>
      </Section>
